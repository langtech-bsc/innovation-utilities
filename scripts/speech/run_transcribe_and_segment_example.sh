...
DEFAULT_PYTHON_SCRIPT="$SCRIPT_DIR/../../examples/speech/transcribe_and_segment_folder_example.py"
DEFAULT_YAML_CONFIG="$SCRIPT_DIR/../../config/speech/transcribe_and_segment_folder.yaml"
